<div class="container-fluid bg-dark text-white p-3 d-flex align-items-center justify-content-between sticky-top">
        <h3 class="mb-0 hb-font">HB-WEBSITE</h3>
        <a href="logout.php" class="btn btn-light btn-sm">LOG OUT</a>
    </div>

    <div class="col-lg-2 bg-dark broder-3 border-secondary border-top " id="dashboard-menu">
            ...
            <div class="container-fluid flex-lg-column align-items-stretch">
                ...
                <div class="collapse navbar-collapse flex-column mt-2 align-items-stretch" id="adminDropdown">
                    <ul class="nav nav-pills flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="feature_facility.php">Feature And Facilities</a>
                        </li>
                        <li class="nav-item">
